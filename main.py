...
comment1 = Comment.objects.create(id_post = post1, id_user = user1, text = "Комментарий пользователя 1 к статье 1", rating = 0)
comment2 = Comment.objects.create(id_post = post2, id_user = user2, text = "Комментарий пользователя 2 к статье 2", rating = 0)
comment3 = Comment.objects.create(id_post = post3, id_user = user1, text = "Комментарий пользователя 1 к новости 1", rating = 0)
comment4 = Comment.objects.create(id_post = post3, id_user = user2, text = "Комментарий пользователя 2 к новости 1", rating = 0)
